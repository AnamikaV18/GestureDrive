...
import time
from my_directkeys import right_pressed, left_pressed
from my_directkeys import PressKey, ReleaseKey  

# Assign scan codes to meaningful names
brake_key = left_pressed
